...
import com.example.basingspringboota2025.service.SboardService;
import com.example.basingspringboota2025.service.SboardService2;
...
public class SboardRestController {
    ...
    @RequestMapping("/list")
    public List<Sboard> list(String title) {
